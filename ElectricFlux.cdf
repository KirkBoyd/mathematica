...
NotebookDataLength[     79098,       1565]
NotebookOptionsPosition[     52804,        996]
NotebookOutlinePosition[     79046,       1557]
CellTagsIndexPosition[     78935,       1551]
WindowTitle->Electric Flux
WindowFrame->Normal*)
...
Cell["Electric Flux", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`A$$ = 1, $CellContext`efs$$ = 
    10, $CellContext`\[Theta]$$ = 0., Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Theta]$$], 0., "angle (rad)"}, 0, 3.14, 0.01}, {{
       Hold[$CellContext`efs$$], 10, "electric field strength (N/C)"}, 0, 100,
       0.01}, {{
       Hold[$CellContext`A$$], 1, 
       "area (\!\(\*SuperscriptBox[\(m\), \(2\)]\))"}, 0, 4, 0.01}}, 
    Typeset`size$$ = {380., {197.5, 202.5}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Theta]$22394$$ = 0, $CellContext`efs$22395$$ = 
    0, $CellContext`A$22396$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`A$$ = 1, $CellContext`efs$$ = 
        10, $CellContext`\[Theta]$$ = 0.}, "ControllerVariables" :> {
        Hold[$CellContext`\[Theta]$$, $CellContext`\[Theta]$22394$$, 0], 
        Hold[$CellContext`efs$$, $CellContext`efs$22395$$, 0], 
        Hold[$CellContext`A$$, $CellContext`A$22396$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Text[
          Row[{"flux (N \!\(\*SuperscriptBox[\(m\), \(2\)]\)/C): ", 
            
            NumberForm[$CellContext`A$$ $CellContext`efs$$ 
             Cos[$CellContext`\[Theta]$$], {5, 2}]}]], 
         Show[{
           Graphics3D[{Green, 
             
             Polygon[{{(-($CellContext`A$$^Rational[1, 2]/2)) 
                Sin[$CellContext`\[Theta]$$], -($CellContext`A$$^
                  Rational[1, 2]/2), ($CellContext`A$$^Rational[1, 2]/2) 
                Cos[$CellContext`\[Theta]$$]}, {(-($CellContext`A$$^
                   Rational[1, 2]/2)) 
                Sin[$CellContext`\[Theta]$$], $CellContext`A$$^Rational[1, 2]/
                2, ($CellContext`A$$^Rational[1, 2]/2) 
                Cos[$CellContext`\[Theta]$$]}, {($CellContext`A$$^
                  Rational[1, 2]/2) 
                Sin[$CellContext`\[Theta]$$], $CellContext`A$$^Rational[1, 2]/
                2, (-($CellContext`A$$^Rational[1, 2]/2)) 
                ...
                Sin[$CellContext`\[Theta]$$], -($CellContext`A$$^
                  Rational[1, 2]/2), (-($CellContext`A$$^Rational[1, 2]/2)) 
                Cos[$CellContext`\[Theta]$$]}}]}, Boxed -> False, 
            PlotRange -> {{-1, 1}, {-1, 1}, {-1, 1}}], 
           
           VectorPlot3D[{$CellContext`efs$$, 0, 0}, {$CellContext`x, -1, 
             1}, {$CellContext`y, -1, 1}, {$CellContext`z, -1, 1}, 
            VectorPoints -> {2, 
              
              If[$CellContext`efs$$ == 0, 2, Ceiling[$CellContext`efs$$/20] + 
               1], 
              
              If[$CellContext`efs$$ == 0, 2, Ceiling[$CellContext`efs$$/20] + 
               1]}, VectorStyle -> {Red, 
              Arrowheads[{0.03, 0.03, Automatic}]}], 
           Graphics3D[{Thick, 
             GrayLevel[0.4], 
             Arrow[{{0, 0, 0}, {
                Cos[$CellContext`\[Theta]$$], 0, 
                Sin[$CellContext`\[Theta]$$]}}]}]}, ImageSize -> 380 {1, 1}]},
         Alignment -> Center], 
      "Specifications" :> {{{$CellContext`\[Theta]$$, 0., "angle (rad)"}, 0, 
         3.14, 0.01, Appearance -> 
         "Labeled"}, {{$CellContext`efs$$, 10, 
          "electric field strength (N/C)"}, 0, 100, 0.01, Appearance -> 
         "Labeled"}, {{$CellContext`A$$, 1, 
          "area (\!\(\*SuperscriptBox[\(m\), \(2\)]\))"}, 0, 4, 0.01, 
         Appearance -> "Labeled"}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{425., {269., 274.}},
...
Cell["\<\
In this Demonstration, you can calculate the electric flux of a uniform \
electric field through a finite plane.\
\>", "ManipulateCaption"],
...
Cell[TextData[{
 ButtonBox["Flux",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Flux.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/Flux.html"],
 " (",
...
Cell[TextData[{
 ButtonBox["Electric Field",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/ElectricField.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/ElectricField.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
ElectricFlux&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ElectricFlux/ElectricFlux-source.nb"]], \
...
Cell[TextData[{
 "\[NonBreakingSpace]",
 ButtonBox["Anoop Naravaram",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Anoop+\
Naravaram"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Anoop+Naravaram"]
}], "Author",
 FontColor->GrayLevel[0.6]],

Cell[TextData[{
 "\"",
 ButtonBox["Electric Flux",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ElectricFlux/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ElectricFlux/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/ElectricFlux/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ElectricFlux/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ElectricFlux/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[40244, 698, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40505, 707, 4440, 96, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[51982, 971, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 78649, 1540},
 {"Copyright", 78844, 1545}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1262, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35593, 600, 34, 0, 70, "DemoTitle"],
Cell[35630, 602, 4459, 89, 70, "Output",
 CellID->1313856824],
Cell[40092, 693, 149, 3, 70, "ManipulateCaption"],
Cell[40244, 698, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40505, 707, 4440, 96, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44948, 805, 44, 0, 70, "RelatedLinksSection"],
Cell[44995, 807, 469, 15, 70, "RelatedLinks",
 CellID->803403110],
Cell[45467, 824, 498, 15, 70, "RelatedLinks",
 CellID->1734094841],
Cell[45968, 841, 4775, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[50746, 932, 45, 0, 70, "CitationSection"],
Cell[50794, 934, 333, 10, 70, "Author"],
Cell[51130, 946, 849, 23, 70, "Citations"],
Cell[51982, 971, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature VRUizwqAMaMCBumBfqFDOoQg *)
